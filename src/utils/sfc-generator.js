...
function genTemplate(formConfig, widgetList) {
...
export const genSFC = function (formConfig, widgetList, beautifier) {
  const html = beautifier.html(genTemplate(formConfig, widgetList), beautifierOpts.html)
  const js = beautifier.js(genVue3JS(formConfig, widgetList), beautifierOpts.js)
  const globalCss = beautifier.css(genGlobalCSS(formConfig), beautifierOpts.css)
  const scopedCss = beautifier.css(genScopedCSS(formConfig), beautifierOpts.css)
